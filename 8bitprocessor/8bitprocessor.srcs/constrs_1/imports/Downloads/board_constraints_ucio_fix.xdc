...
set_property PACKAGE_PIN C5  [get_ports {F[2]}]  ; set_property IOSTANDARD LVCMOS25 [get_ports {F[2]}]   ;# moved from C4 to C5
...
set_property PACKAGE_PIN G2  [get_ports {LoadA}]   ; set_property IOSTANDARD LVCMOS25 [get_ports {LoadA}]   ;# KEY2 (named 'Load' in table)
