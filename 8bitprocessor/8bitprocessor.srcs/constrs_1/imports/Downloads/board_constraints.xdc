...
set_property PACKAGE_PIN C4  [get_ports {F[2]}]  ; set_property IOSTANDARD LVCMOS25 [get_ports {F[2]}]
...
## Push buttons
set_property PACKAGE_PIN J1  [get_ports {LoadB}] ; set_property IOSTANDARD LVCMOS25 [get_ports {LoadB}]
set_property PACKAGE_PIN G2  [get_ports {Load}]  ; set_property IOSTANDARD LVCMOS25 [get_ports {Load}]
set_property PACKAGE_PIN J2  [get_ports {Reset}] ; set_property IOSTANDARD LVCMOS25 [get_ports {Reset}]
set_property PACKAGE_PIN H2  [get_ports {Execute}] ; set_property IOSTANDARD LVCMOS25 [get_ports {Execute}]
...
set_property PACKAGE_PIN C5 [get_ports {hex_seg[3]}] ; set_property IOSTANDARD LVCMOS25 [get_ports {hex_seg[3]}]
...
set_property PACKAGE_PIN C4 [get_ports {hex_seg[6]}] ; set_property IOSTANDARD LVCMOS25 [get_ports {hex_seg[6]}]
